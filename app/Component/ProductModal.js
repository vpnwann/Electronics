...
export default function ProductModal({ product, isOpen, onClose }) {
  ...
  return (
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      ...
      <div className="bg-white p-6 rounded-md shadow-md w-11/12 md:w-3/4 lg:w-1/2 relative">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex mb-4">
                  <span className="flex items-center">
                    {[...Array(5)].map((_, index) => (
                      <svg key={index} fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 text-indigo-500" viewBox="0 0 24 24">
                ...
                <div className="flex">
                  ...
                  <button  onClick={(e) => { e.stopPropagation(); handleAddToCart(product) }} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to Cart</button>
